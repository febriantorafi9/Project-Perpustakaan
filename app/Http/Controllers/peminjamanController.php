...
class peminjamanController extends Controller
{
    ...
    public function tambah()
    {
        ...
        return view('/peminjaman/tambah',['buku' => $buku]);

        // menampilkan data petugas yang melayani saat itu juga
        $petugas = DB::table('petugas')-> get();
        return view('/peminjaman/tambah',['petugas' => $petugas]);
        
        // menampilkan data anggota yang ingin meminjam buku
        $anggota = DB::table('anggota')-> get();
        return view('/peminjaman/tambah',['anggota' => $anggota]);
    }

    public function simpan(Request $request)
    {
        DB::table('peminjaman')->insert([
            'id_peminjaman'=>$request->id_pengembalian,
